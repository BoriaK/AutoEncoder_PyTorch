...
class DeConvBlock2(nn.Module):
    def __init__(self, c_in, c_out, kernel_size=(4, 4), stride=2, padding=0, dilation=1):
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.l2 = DeConvBlock2(64, 32, kernel_size=4, stride=2, padding=0, dilation=1)
        self.l3 = DeConvBlock1(32, 64, kernel_size=3, stride=1, padding=0, dilation=1)
        self.l4 = DeConvBlock2(64, 32, kernel_size=4, stride=2, padding=0, dilation=1)
        self.l5 = DeConvBlock1(32, 64, kernel_size=3, stride=1, padding=0, dilation=1)
        self.l6 = DeConvBlock2(64, 32, kernel_size=4, stride=2, padding=0, dilation=1)
